...
import { C, MOODS, Face, Tile, Eyebrow, EvoAvatar, computeStreak, stageFromStreaks } from "../design";
...
export default function Journal({ logs, profile }) {
  ...
  return (
    <div>
      <div style={{ fontSize: 22, fontWeight: 900, textAlign: "center", marginBottom: 12 }}>📖 Journal</div>
...
function YearView({ logs, year }) {
  ...
  return (
    <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 10 }}>
      {months.map((m, i) => (
        <div key={i} style={{ background: m ? "#fff" : "#F5F3F8", border: `2px solid ${C.line}`, borderRadius: 18, padding: "10px 4px", textAlign: "center" }}>
